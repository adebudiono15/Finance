                                ...
                                <table id="basic-datatables" class="display table table-striped table-hover" >
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td hidden>{{ $e+1 }}</td>
                                            <td>{{ $item->kode_piutang }}</td>
                                            <td>{{ $item->nama_customer_id }}</td>
                                            ...
                                            <td class="text-center" style="width: 200px">
                                                ...
                                                <a href="{{ url('piutang/pdf/'.$item->id) }}" target="_blank" class="btn btn-sm btn-warning btn-shadow mr-2 mt-2 mb-2 btn-drb">
                                                ...
                                                <a href="#" data-id="{{ $item->id }}"
                                                    ...
                                                    <form action="{{ route('delete-piutang', $item->id) }}"
                ...
                <form class="form form-vertical" method="post" enctype="multipart/form-data"
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="nama_customer_id" @error('nama_customer_id') class="text-danger" @enderror>CUSTOMER @error('nama_customer_id')
                                        | {{ $message }}
                                        @enderror</label>
                                        <select id="nama_customer_id" name="nama_customer_id" class="js-states form-control" style="width: 100%">
                                            <option value=""></option>
      ...
      <div id="insertbarang" class="modal fade" style="display: none;" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form class="form form-vertical" method="post" enctype="multipart/form-data"
                    action="{{ route('save-barang-piutang') }}">
                    @csrf
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg">
