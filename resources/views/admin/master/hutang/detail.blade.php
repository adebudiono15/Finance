    <input type="hidden" name="id" value="{{ $hutang->id }}" id="id_data" />
    {{-- detail --}}
    <div class="row">
    ...
    <div class="row mt-1">
        <div class="col-md-4 mt-3">
            ...
            <h6>{{ $hutang->kode_hutang }}</h6>
        </div>
        <div class="col-md-4 mt-3">
            <h6><b>TANGGAL</b></h6>
            <h6>{{ date('d F Y', strtotime ($hutang->tanggal)) }}</h6>
        </div>
        <div class="col-md-4 mt-3">
            <h6><b>NAMA SUPPLIER</b></h6>
            <h6>{{ $hutang->nama_supplier_id }}</h6>
        </div>
    </div>
        ...
        <div class="col-md-12 mt-3">
            <div class="table-responsive">
                <table id="basic-datatables" class="display table table-striped table-hover" >
                    ...
                    <tbody>
                        @foreach ($hutang->lines as $e=> $item)
                        <tr>
                            <td>{{ $e+1 }}</td>
            ...
            <p class="float-right"><small>Grand Total : </small><b>Rp. {{ number_format($hutang->grand_total,0) }}</b></p>
        </div>
    </div>
    {{-- last detail --}}
<hr>
        ...
        <div class="col-md-12 mt-3">
            <div class="table-responsive">
                <table id="basic-datatables" class="display table table-striped table-hover" >
                    ...
                    <tbody>
                        @foreach ($hutang->riwayat as $e=> $item)
                        <tr>
                            <td>
                               {{ $e+1 }}
                            </td>
                            ...
                            <td>
                                {{ date('d F Y ', strtotime ($hutang->created_at)) }}
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
