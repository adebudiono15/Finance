...
@section('content')
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center" style="width: 200px">
                                                ...
                                                <a href="#" data-id="{{ $item->id }}"
                                                    ...
                                                    <form action="{{ route('delete-divisi', $item->id) }}"
        ...
        <div class="modal-dialog ">
            <div class="modal-content">
                <div class="modal-header bg-dark">
                    <h5 class="modal-title text-white">TAMBAH DATA DIVISI</h5>
                    <button type="button" class="close text-white" data-dismiss="modal">×</button>
                </div>
                <form class="form form-vertical" method="post" enctype="multipart/form-data"
                    action="{{ route('save-divisi') }}">
                    @csrf
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg">
                                <div class="form-group">
                                    <label for="nama_divisi" @error('nama_divisi') class="text-danger" @enderror>DIVISI @error('nama_divisi')
                                        | {{ $message }}
                                        @enderror</label>
                                    <input type="text" class="form-control" value="{{ old('nama_divisi') }}"
                                        name="nama_divisi" placeholder="-" style="height: 28px;">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div id="edit" class="modal fade" style="display: none;" aria-hidden="true">
        <div class="modal-dialog ">
            <div class="modal-content">
                <div class="modal-header bg-dark">
                    <h5 class="modal-title text-white">EDIT DATA DIVISI</h5>
                    <button type="button" class="close text-white" data-dismiss="modal">×</button>
                </div>
