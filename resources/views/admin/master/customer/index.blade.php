                ...
                <form class="form form-vertical" method="post" enctype="multipart/form-data"
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="kode_customer" @error('kode_customer') class="text-danger" @enderror>KODE CUSTOMER @error('kode_customer')
                                        | {{ $message }}
                                        @enderror</label>
                                    <input type="text" class="form-control" value="CS{{ $kode_uniq }}"
                                ...
                                <div class="form-group">
                                    <label for="telepon" @error('telepon') class="text-danger" @enderror>TELEPON @error('telepon')
                                        | {{ $message }}
                                        @enderror</label>
                                    <input type="number" class="form-control" value="{{ old('nama_customer') }}"
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="nama_customer" @error('nama_customer') class="text-danger" @enderror>NAMA @error('nama_customer')
                                        | {{ $message }}
                                        @enderror</label>
