                                ...
                                <table id="basic-datatables" class="display table table-striped table-hover" >
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ Str::limit($item->nama_supplier,10) }}</td>
                                            {{-- <td>{{ $item->alamat }}</td> --}}
                                            {{-- <td>{{ $item->telepon }}</td> --}}
                                            {{-- <td>{{ $item->email }}</td> --}}
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="kode_supplier" @error('kode_supplier') class="text-danger" @enderror>KODE SUPPLIER @error('kode_supplier')
                                        | {{ $message }}
                                        @enderror</label>
                                    <input type="text" class="form-control" value="SP{{ $kode_uniq }}"
                                        name="kode_supplier" placeholder="-" style="height: 28px;" readonly>
                                </div>
                                ...
                                <div class="form-group">
                                    <label for="telepon" @error('telepon') class="text-danger" @enderror>TELEPON @error('telepon')
                                        | {{ $message }}
                                        @enderror</label>
                                    <input type="number" class="form-control" value="{{ old('nama_supplier') }}"
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="nama_supplier" @error('nama_supplier') class="text-danger" @enderror>NAMA @error('nama_supplier')
                                        | {{ $message }}
                                        @enderror</label>
                                    <input type="text" class="form-control" value="{{ old('nama_supplier') }}"
                                        name="nama_supplier" placeholder="-" style="height: 28px;">
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="alamat" @error('alamat') class="text-danger" @enderror>ALAMAT @error('alamat')
                                        | {{ $message }}
                                        @enderror</label>
                                    <input type="text" class="form-control" value="{{ old('alamat') }}"
